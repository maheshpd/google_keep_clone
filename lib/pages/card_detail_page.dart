  ...
  AppBar getAppBar(){
    return AppBar(
      ...
      actions: [
        IconButton(
          onPressed: null,
          icon: Icon(MaterialCommunityIcons.pin,color: white.withOpacity(0.7),
          size: 22),
        ),
        IconButton(
          onPressed: null,
              ...
              children: List.generate(widget.img.length, (index) {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(image: NetworkImage(widget.img[index]),
                    fit: BoxFit.cover)
                  ),
                ),
                );
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Text("Edited Apr 3", style: TextStyle(fontSize: 12, color: white.withOpacity(0.7)),),
            IconButton(
              onPressed: null,
